                        ...
                        <div className="container">
                            <div className="row d-flex justify-content-between">
                                <div className="dlab-topbar-left">
                                    <ul>
                                        <li><i className="flaticon-phone-call m-r5"></i><a href="tel:8763889700">( +91 ) 8763889700</a></li>
                                        <li><i className="ti-location-pin m-r5"></i> DLF Cybercity, 6th Floor, Patia</li>
                                    </ul>
                                </div>
                                <div className="dlab-topbar-right">
                                    <ul>
                                        <li><i className="ti-skype m-r5"></i> Teceads Solutions</li>
                                        <li><i className="ti-email m-r5"></i><a href="mailto:teceads@gmail.com"> teceads@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="main-bar clearfix ">
                            <div className="container clearfix">
                                <div className="logo-header mostion">
                                    <Link to={'./'} className="dez-page"><img src={logo} alt="teceads logo" /></Link>
                                </div>
